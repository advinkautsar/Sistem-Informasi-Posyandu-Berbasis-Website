...
@section('title 1')
Formulir Edit Akun Petugas Desa
@endsection
...
<div class="col-md-12">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form action="{{route('petdes.update',$data_user->id)}}" method="POST" aria-label="abdul" data-id="abdul" class="needs-validation" novalidate="" autocomplete="off">
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="tel" placeholder="Masukan nomor handphone" aria-label="default input example" name="no_hp" value="{{$data_user->no_hp}}" id="validationCustom01">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" placeholder="Masukan nama petugas desa" value="{{$data_user->petugas_desa->nama}}" aria-label="default input example" name="nama" id="validationCustom01" required autofocus>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" placeholder="Masukan alamat petugas desa" aria-label="default input example" name="alamat" value="{{$data_user->petugas_desa->alamat}}" id="validationCustom01" required autofocus>
