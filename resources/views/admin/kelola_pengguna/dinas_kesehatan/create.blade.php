...
@section('title 1')
Formulir Daftar Akun Dinas Kesehatan
@endsection
...
<div class="col-md-12">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('dinkes.store')}}" method="POST" aria-label="abdul" data-id="abdul" class="needs-validation" novalidate="" autocomplete="off">
                ...
                <div class="col-md-12">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="tel" placeholder="Masukan nomor handpone pengguna" aria-label="default input example" name="no_hp" id="validationCustom01">
                    </div>
                    <div class="mb-3">
