...
@section('title 1')
Formulir Daftar Data Kader Baru
@endsection
        ...
        <div class="card-body">
            <form action="{{route('kelola_kader.store')}}" method="POST" aria-label="abdul" data-id="abdul" class="needs-validation" novalidate="" autocomplete="off">
                ...
                <div class="col-md-12">
                    ...
                    <h6 class="fw-bold mt-5 ">Data Profil Kader</h6>

                    <div class="col-md-12">
                        <div class="mb-3">
                            <label for="basicInput" class="form-label">Nama Kader</label>
                            <input class="form-control" type="text" placeholder="ex : Laila.." aria-label="default input example" name="nama_kader" id="validationCustom01" required autofocus>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control" type="text" placeholder="ex: Jl. Cendrawasih..." aria-label="default input example" name="alamat" id="validationCustom01" required autofocus>
