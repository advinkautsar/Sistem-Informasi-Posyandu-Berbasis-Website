...
<div class="col-md-12">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{route('tips.update',$tips->id)}}" method="POST" aria-label="abdul" data-id="abdul" class="needs-validation" novalidate="" autocomplete="off">
                ...
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" value="{{$tips->judul_tips}}" placeholder="Masukan Judul" aria-label="default input example" name="judul_tips" id="validationCustom01" required autofocus>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="keterangan" id="summernote" cols="30" rows="10">
                            {{$tips->keterangan}}
                        </textarea>
